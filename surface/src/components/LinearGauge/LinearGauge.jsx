...
export default class LinearGauge extends React.Component {
    render() {
        ...
        if(this.props.inverted){
            fg = <rect width={this.props.gauge_width} height={this.props.value} fill="#A6A6A6"></rect>;
            tri = <g transform={"translate(0,"+(shiftH + this.props.value) + ")"}>
                    <polygon points={pointerStr} fill="#807E7E"/>
                  </g>;

        }else{
            fg = <rect width={this.props.gauge_width} height={this.props.gauge_height-this.props.value} fill="#A6A6A6"></rect>;
            tri = <g transform={"translate(0,"+((this.props.gauge_height + shiftH) - this.props.value) + ")"}>
                    <polygon points={pointerStr} fill="#807E7E"/>
                  </g>;
        }
        return (
