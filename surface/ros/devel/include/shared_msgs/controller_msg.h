...
bool operator==(const ::shared_msgs::controller_msg_<ContainerAllocator1> & lhs, const ::shared_msgs::controller_msg_<ContainerAllocator2> & rhs)
{
  return lhs.RX_axis == rhs.RX_axis &&
    lhs.RY_axis == rhs.RY_axis &&
    lhs.LX_axis == rhs.LX_axis &&
    lhs.LY_axis == rhs.LY_axis &&
    lhs.a == rhs.a &&
    lhs.b == rhs.b &&
    lhs.x == rhs.x &&
    lhs.y == rhs.y &&
    ...
    lhs.RB == rhs.RB &&
    lhs.LB == rhs.LB &&
    lhs.Rtrigger == rhs.Rtrigger &&
    lhs.Ltrigger == rhs.Ltrigger;
}
