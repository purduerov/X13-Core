...
bool operator==(const ::shared_msgs::auto_control_msg_<ContainerAllocator1> & lhs, const ::shared_msgs::auto_control_msg_<ContainerAllocator2> & rhs)
{
  return lhs.thrust_vec == rhs.thrust_vec &&
    lhs.dims_locked == rhs.dims_locked;
}
