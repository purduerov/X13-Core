...
bool operator==(const ::shared_msgs::final_thrust_msg_<ContainerAllocator1> & lhs, const ::shared_msgs::final_thrust_msg_<ContainerAllocator2> & rhs)
{
  return lhs.hfl == rhs.hfl &&
    lhs.hfr == rhs.hfr &&
    lhs.hbr == rhs.hbr &&
    lhs.hbl == rhs.hbl &&
    lhs.vfl == rhs.vfl &&
